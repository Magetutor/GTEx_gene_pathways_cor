...
function paletteToPlotly(name, reverse){
  // basic mappings for viridis family using Plotly built-in scales
...
// compute marker sizes (pixels) from numeric values with optional log transform
...
// Setup drag-and-drop convenience (works when opened via file:// without requiring a server)
try{
...
// Expose helpers to global window for debugging in Console
try{
...
}catch(e){ /* ignore if running in restricted contexts */ }
